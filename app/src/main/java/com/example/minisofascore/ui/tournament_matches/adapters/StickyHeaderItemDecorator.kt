...
class StickyHeaderItemDecorator(private val mListener: StickyHeaderInterface) :
    ItemDecoration() {
    ...
    interface StickyHeaderInterface {
        /**
         * This method gets called by [StickyHeaderItemDecorator] to fetch the position of the header item in the adapter
        ...
        /**
         * This method gets called by [StickyHeaderItemDecorator] to get layout resource id for the header item at specified adapter's position.
        ...
        /**
         * This method gets called by [StickyHeaderItemDecorator] to verify whether the item represents a header.
